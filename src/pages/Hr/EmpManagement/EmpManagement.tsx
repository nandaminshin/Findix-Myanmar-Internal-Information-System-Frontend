        ...
        <div className="emp-management-page">
            <div className="main-content">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                    <div>
                        <h1 className="page-title">Employee Management (HR)</h1>
                        <p className="page-subtitle">Manage your organization's workforce and access controls</p>
                    </div>
                    <button
                        onClick={() => navigate('/hr/create-new-employee')}
                        ...
                        <table className="emp-table">
                            ...
                            {employees.map((employee) => (
                                <tr key={employee.id}>
                                    ...
                                    <td className=''>
                                        {/* PERMISSION CHECK: HR cannot manage GM or MD */}
                                        {!['gm', 'md'].includes(employee.role) && (
                                            <>
