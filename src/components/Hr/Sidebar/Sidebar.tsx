    ...
    return (
        <aside className={`sidebar ${isOpen ? '' : 'closed'}`} aria-hidden={!isOpen}>
            ...
            <nav className="sidebar-nav">
                <ul>
                    <li>
                        <NavLink to="/hr" end className="sidebar-link">
                            <Home size={20} />
                            <span>Home</span>
                        </NavLink>
                    </li>
                    ...
                    <li>
                        <NavLink to="/hr/leave-request" className="sidebar-link">
                            <FileText size={20} />
                            <span>Leave Request</span>
                        </NavLink>
                    </li>
                    <li>
                        <NavLink to="/hr/salary" className="sidebar-link">
                            <CircleDollarSign size={20} />
                            <span>Salary</span>
                        </NavLink>
                    </li>
                    <li>
                        <NavLink to="/hr/employee-management" className="sidebar-link">
                            <Users size={20} />
